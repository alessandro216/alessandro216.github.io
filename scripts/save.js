...
saveButton.onclick = function(e) {
  ...
  let boxPosition = cordinateCont + 60 - cordinateBtn;
  saveButtonPosition(boxPosition);
  boxMove.style.top = boxPosition + 'px';
};
...
if (percent > 0) {
  if (confirm("Would you like to continue reading where you left off?")) {
      ...
      let lastBoxPosition = loadButtonPosition();
      boxMove.style.top = lastBoxPosition + "px";
  }
